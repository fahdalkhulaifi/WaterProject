...
namespace WaterNetwork.WPF.Services.Utils
{
    public class NumberToWordConverter
    {
        ...
        public NumberToWordConverter(decimal number, CurrencyInfo currency)
        {
        ...
        public NumberToWordConverter(decimal number, CurrencyInfo currency, string englishPrefixText, string englishSuffixText, string arabicPrefixText, string arabicSuffixText)
        {
